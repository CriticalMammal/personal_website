/* 
Created by Dylan Gallardo, August 1, 2015.
Website: http://dylangallardo.com
Twitter: https://twitter.com/CriticalMammal
...
var slowdownEffect = 0.886; // lower values slowdown faster

// create gradient
var polyGradient = canvasContext.createLinearGradient(0, 0, 0, window.innerHeight);
polyGradient.addColorStop(1, '#a8b9ba'); //lightyellow
polyGradient.addColorStop(0, "#a8b9ba"); //lightblue
...
function main() {
  ...
  var y = canvas.height/1.8;
  var spacing = 25;
  var springDistance = 25;
  var dampener = 0.08;
  var minDampener = 0.002;
    ...
    if (drawSprings) {
      ...
      for (var i=0; i<springs.length; i++) {
        ...
        if (springs[i].goodDistance) {
          ...
          canvasContext.strokeStyle = springColor;
        }
